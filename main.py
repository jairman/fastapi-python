...
#Define the SQLModel for the database
...
url_connection = f"mysql+pymysql://{db_username}:{db_password}@{db_host}:{db_port}/{db_name}"
...
def read_heroes(
    session: session_dep,
    offset: int = 0,
    limit: Annotated[int, Query(lte=100)] = 100,
):
